// Package registry loads and parses the local problem registry manifests.
// The registry is a directory of JSON files: index.json → provider manifests → track manifests.
package registry
