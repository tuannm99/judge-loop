// Package timer provides an in-memory timer for tracking active practice sessions.
// State is lost on process restart — SQLite persistence is a future milestone concern.
package timer
