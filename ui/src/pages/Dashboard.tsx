  ...
  return (
    <Stack p="lg" gap="xl" maw={900}>
      ...
      <SimpleGrid cols={{ base: 2, md: 4 }}>
        <StatCard
          label="Solved today"
          value={progress?.solved ?? 0}
          icon={<IconTarget size={16} />}
        />
        <StatCard
          label="Attempted"
          value={progress?.attempted ?? 0}
          icon={<IconCalendarCheck size={16} />}
        />
        <StatCard
          label="Time today"
          value={`${progress?.time_spent_minutes ?? 0}m`}
          icon={<IconClock size={16} />}
        />
        <StatCard
          label="Streak"
          value={streak?.current ?? 0}
          icon={<IconFlame size={16} color="var(--mantine-color-orange-4)" />}
        />
      </SimpleGrid>
